...
const SOCIAL_LINKS = [
  ...
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/awosoji-emmanuel-9407222b8/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/manjtech?igsh=MXRuZG4zNGo5cW5hcw==",
  },
];
        ...
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div
              ...
              data-aos-delay="600"
            >
              <div className="relative w-full opacity-90 pb-10 ">
                <div
                ...
                >
                  ...
                  <video
                    ...
                    muted
                    playsInline
                    className="w-72 lg:w-96 h-auto object-contain rounded-2xl mx-auto"
                  >
                    <source
                      src="/coding.webm"
                      type="video/webm"
